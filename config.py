...
"""
Centralized configuration management for TCD-SegFormer model.
...
DEFAULT_CONFIG = {
    ...
    "use_true_res_segformer": False,  
    "interpolation_mode": "bilinear", 
    "interpolation_align_corners": False,  

    # Training parameters 
    "output_dir": "./outputs_baseline_mit_b5",
    "train_batch_size": 1,
    "eval_batch_size": 2,
    "num_epochs": 50,
    "learning_rate": 1e-5,
    ...
    "apply_loss_at_original_resolution": False,
    ...
    "num_worst_samples": 5,
    "visualize_confidence_comparison": True,
    "analyze_errors": True,
...
class Config:
    """
    Configuration class for TCD-SegFormer.
    ...
    def validate(self) -> List[str]:
        ...
        # Validate use_true_res_segformer
        if not isinstance(self._config.get("use_true_res_segformer", True), bool):
            errors.append("use_true_res_segformer must be a boolean")
